...
`just valgrind32` (best-effort ILP32; GCC default, `CC=clang` selects clang;
skip cleanly without multilib or the 32-bit runtimes), `just sanitize`,
`just valgrind`, `just green`, `just green-fix`,
