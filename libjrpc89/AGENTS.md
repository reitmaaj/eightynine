...
`just sanitize32` are the best-effort ILP32 recipes (GCC default, `CC=clang`
selects clang); they skip cleanly when 32-bit multilib or the 32-bit
sanitizer runtime is absent.
