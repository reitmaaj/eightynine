...
AS a C program that must call a remote JSON-RPC 2.0 service over a stream
socket
...
AS an operator debugging a JSON-RPC 2.0 stream-socket service
...
I WANT a protocol core whose every translation unit passes the seven-check
matrix
