...
struct raft89
{
    ...
    raft89_index ae_prev_index;
    raft89_term ae_prev_term;
    raft89_index ae_leader_commit;
    raft89_id ae_leader_id;
    raft89_index ae_match_index;
    raft89_index ae_truncate_first;
...
int raft89__emit_hard_state(raft89 *node, raft89_term term,
                            raft89_id voted_for);
